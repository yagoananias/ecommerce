                ...
                <div class="col-md-3 col-sm-6">
                    <div class="footer-about-us">
                        ...
                        <div class="footer-social">
                            <a href="https://www.facebook.com/profile.php?id=100010705451338" target="_blank"><i class="fa fa-facebook"></i></a>
                            <a href="https://twitter.com/yagoananiasbr" target="_blank"><i class="fa fa-twitter"></i></a>
                            <a href="https://www.youtube.com/channel/UCdcquoVj_KHPRIkkNwVcLlA" target="_blank"><i class="fa fa-youtube"></i></a>
                        </div>
                    </div>
                </div>
    ...
    <div class="footer-bottom-area">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="copyright">
                        <p>&copy; 2017 Yago Ananias Souza Lima. <a href="https://github.com/yagoananias" target="_blank">Meu GitHub</a></p>
                    </div>
                </div>
